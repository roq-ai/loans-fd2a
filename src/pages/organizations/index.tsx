...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'financial_advisor.count', 'personal_loan.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('financial_advisor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'financial_advisor',
          header: 'Financial Advisor',
          accessorKey: 'financial_advisor',
          cell: ({ row: { original: record } }: any) => record?._count?.financial_advisor,
        }
      : null,
    hasAccess('personal_loan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'personal_loan',
          header: 'Personal Loan',
          accessorKey: 'personal_loan',
          cell: ({ row: { original: record } }: any) => record?._count?.personal_loan,
        }
      : null,
