...
import { PersonalLoanListPage } from 'pages/personal-loans';
import { getFinancialAdvisors, deleteFinancialAdvisorById, createFinancialAdvisor } from 'apiSdk/financial-advisors';
      ...
      <Box rounded="md">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createFinancialAdvisor}
                deleteHandler={deleteFinancialAdvisorById}
                fetcher={getFinancialAdvisors}
