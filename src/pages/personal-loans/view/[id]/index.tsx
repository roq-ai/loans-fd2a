...
import { getPersonalLoanById } from 'apiSdk/personal-loans';
import { PersonalLoanInterface } from 'interfaces/personal-loan';

function PersonalLoanViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Loan Amount" text={data?.loan_amount} />

                <FormListItem label="Extra Fees" text={data?.extra_fees} />
